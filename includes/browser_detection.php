...
$a_browser_data = browser_detection('full_assoc');
//echo '<pre>';print_r($a_browser_data);
$brw = $a_browser_data['browser_working'];
if($brw=='ie') $brw = 'trident';
$brwoserData= $a_browser_data[$brw.'_data'];

$Config['Browser'] = ucfirst($brwoserData[0]).' : '.$brwoserData[1];
?>
