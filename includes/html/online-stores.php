  ...
  <tr>
    ...
    <td align="left" width="100%" valign="top"><table cellspacing="0" cellpadding="0" id="container4">
	   ...
	   <tr>
		...
		require_once("includes/html/box/featured.php"); 
		
		$WebsiteTitle = FEATURED_STORES;
		require_once("includes/html/box/featured_store.php");
		
		if($numPartner>0){
			require_once("includes/html/box/partners.php"); 
		}
