<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left"  width="100%" valign="top"><table cellspacing="0" cellpadding="0" width="100%" align="center">
	  ...
	  <tr>
        <td height="32" align="left" valign="middle" class="pagenav"><span ><?=$Nav_Home?>  <?=$Nav_MemberPortal?> </span> <?=CHANGE_TEMPLATE?></td>
      </tr>
      <tr>
        <td  align="left" valign="middle" class="heading"><?=CHANGE_TEMPLATE?></td>
      </tr>
      <tr>
        <td height="15"></td>
      </tr>
<tr>
	...
	<? }?>	
		 ...
		 <? if(!empty($_SESSION['mess_template'])) { ?>
	   <tr>
 ...
 ?>
	  ...
	  <input type="hidden" name="MemberID" id="MemberID" value="<? echo $_SESSION['MemberID']; ?>" /></td>
	  </tr>
