<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left" width="100%" valign="top"><table cellspacing="0" cellpadding="0" id="container4">
            <tr>
              <td height="32" align="left" valign="middle" class="pagenav"><span ><?=$Nav_Home?> </span> <?=BROWSE_WEBSITES?> </td>
            </tr>
            <tr>
              <td  align="left" valign="middle" class="heading"><?=BROWSE_WEBSITES?></td>
            </tr>
            <tr>
              <td height="15"></td>
            </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
			...
			<?  echo Alphabets('alpha-websites.php?ch=','',$_GET['ch']); ?>
  ...
  <tr>
	...
	<? //if($_GET['ch'] != ''){?> <!--<a href="alpha-products.php"><?=VIEW_ALL?></a>&nbsp;&nbsp;-->	<? //} ?>
	   ...
	   <tr>
        <td valign="top"><? require_once("includes/html/box/websites.php"); ?></td>
      </tr>	
