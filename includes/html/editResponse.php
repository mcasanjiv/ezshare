<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <tr>
        <td height="32" align="left" valign="middle" class="pagenav"><span ><?=$Nav_Home?>  <?=$Nav_MemberPortal?>
			 ...
			 <a href="viewBlog.php" class="skytxt"><?=MANAGE_BLOG?></a>  <a href="viewResponse.php?TopicID=<?=$_GET['TopicID']?>" class="skytxt"><?=BLOG_RESPONSES?></a> </span> <?=$ModuleTitle?>
      ...
      <tr>
        <td height="15"></td>
	   	 ...
	   	 <tr>
            <td colspan="2" align="right"  valign="top"  class="skytxt">
			<a href="viewResponse.php?TopicID=<?=$_GET['TopicID']?>">Back to <? echo BLOG_RESPONSES; ?></a></td>
          </tr>
		     <tr>
 ...
 <? if(!empty($_GET['TopicID'])){ ?>		
   ...
   <tr>
    <td width="12%"    valign="top" ><?=BLOG_DATE?></td>
    <td  align="left"   valign="top" >
	<? 	
  ...
  <tr>
    <td   width="18%"  valign="top"><?=BLOG_COMMENTS?>  <span class="bluestar">*</span>&nbsp;  </td>
    <td  align="left">
	<textarea name="CommentDetail" id="CommentDetail" class="txtfield_contact"  cols="50" rows="15" style="width:330px;" ><?php echo stripslashes($arryBlog[0]['CommentDetail']); ?></textarea>
	<input name="Comment" type="hidden" id="Comment" value="Response Comment">
	<br><span >( Between 10-2000 characters.)</span><br><br></td>
  </tr>
   <tr>
...
<? 
		  ...
		  <input type="radio" name="Status" id="Status" value="0" <?=$InActiveChecked?>>InActive    </span></td>
			  ...
			  <input type="hidden" name="TopicID" id="TopicID" value="<?=$_GET['TopicID']?>" />			  								  </td>
                                </tr>
                            </table></td>
                          </tr>
                        </table></td>
