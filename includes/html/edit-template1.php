...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="blacktxt" id="BodyTopID" >
  <tr>
    ...
    <td width="12%" valign="top" ><input name="BodyBgColor" type="text" class="txtfield" id="BodyBgColor" value="<?=$BodyBgColor?>" size="4" maxlength="8"  readonly=""/>
...
<tr>
    ...
    <td width="12%" valign="top"> <input name="HeaderBgColor" type="text" class="txtfield" id="HeaderBgColor" value="<?=$HeaderBgColor?>" size="4" maxlength="8"  readonly=""/>
...
&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;Color:
<input name="HeaderFontColor" type="text" class="txtfield" id="HeaderFontColor" value="<?=$HeaderFontColor?>" size="4" maxlength="8"  readonly=""/>
...
<input name="BannerFontColor" type="text" class="txtfield" id="BannerFontColor" value="<?=$BannerFontColor?>" size="4" maxlength="8"  readonly=""/>
