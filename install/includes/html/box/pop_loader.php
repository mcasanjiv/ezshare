<div id="light_home" class="white_content" style="width:240px;" >
 <!--a href="Javascript:ShowHideLoader(0);"><img src="images/delete.gif" style="float:right"></a-->
	...
	<div style="width:155px;float:left;padding-top:15px;">
		...
		<div id="PopLoader_D" style="display:none"><?=LOADER_MSG_D?></div>
	</div>
...
function ShowHideLoader(opt,DivID){
	...
	if(document.getElementById("footer") != null){
			if(opt==1){
					...
					document.getElementById('PopLoader_D').style.display='none';
