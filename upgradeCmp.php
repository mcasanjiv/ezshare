<?php   
	...
	//echo strtotime("2015-08-15");
     ...
     $XmlContent = '<?xml version="1.0" encoding="ISO-8859-1"?>
		<subscriptiondetail>
		<userid>111</userid>
		<usename>parwez</usename>
		<email>parwez005@gmail.com</email>		
	...
	$objCompany=new company();
	 ...
	 if(!empty($arryCompany['Email'])) {
		...
		if($objConfig->isCmpEmailExists($arryCompany['Email'],'')){	
			...
			$_SESSION['mess_company'] = COMPANY_UPGRADED;
			$CmpID = $objCompany->UpgradeCompany($arryCompany);
			$UpdateAdminMenu = 1;
