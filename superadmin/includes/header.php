...
<div class="nav-container" id="main_menu">
		...
		<li  class="<?=($SelfPage=="viewUserLog.php" || $SelfPage=="editUserLog.php")?("active"):("")?>" ><a href="viewUserLog.php" class="menu_link">User Log</a></li>
		<li  class="<?=($SelfPage=="pageList.php" || $SelfPage=="pageList.php")?("active"):("")?>" ><a href="pageList.php" class="menu_link">CRM Website</a></li>
		<li  class="<?=($SelfPage=="callServerList.php" || $SelfPage=="callServerList.php")?("active"):("")?>" ><a href="callServerList.php" class="menu_link">Call Server</a></li>
