...
<? if(!empty($_SESSION['mess_footer_link'])) {echo $_SESSION['mess_footer_link']; unset($_SESSION['mess_footer_link']); }?>
</div>
    ...
    unset($_SESSION['mess_Page']);
            ...
            <table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    ...
                    <td width="39%" align="right"> <a href="footerSocialLinks.php" class="add">Add New Social Links</a>      </td>
                </tr>
                ...
                if (is_array($arryPages) && $num > 0) {
                    ...
                    foreach ($arryPages as $key => $values) {
                        ...
                        <tr align="left"  bgcolor="<?= $bgcolor ?>">
                            ...
                            <td height="26" align="center"><?= $values['URI']; ?></td>
                             <td height="26" align="center">
                             <img border="0" src="../resizeimage.php?w=100&amp;h=100&amp;img=images/<?= $values['Icon']; ?>">
                             </td>
                            <td align="center" ><?
                        ...
                        echo '<a href="footerSocialLinks.php?active_id=' . $values["id"] . '&curP=' . $_GET["curP"] . '" class="' . $status . '">' . $status . '</a>';
                        ?>
                            </td>
                            <td height="26" align="right"  valign="top">
                                <a href="footerSocialLinks.php?edit=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>" class="Blue"><?= $edit ?></a>
                                <a href="footerSocialLinks.php?del_id=<?php echo $values['id']; ?>&curP=<?php echo $_GET['curP']; ?>" onclick="return confDel('<?= $cat_title ?>')" class="Blue" ><?= $delete ?></a>              
                                &nbsp;
                            </td>
                        </tr>
                    <?php } // foreach end //?>
