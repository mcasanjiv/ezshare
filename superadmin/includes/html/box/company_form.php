...
<option value="h:i:s a" <?=($arryCompany[0]['TimeFormat']=='h:i:s a')?('selected'):('')?> > am / pm </option>
   ...
   <tr>
        <td  align="right"   class="blackbold"> Display Name  :<span class="red">*</span> </td>
        <td   align="left" >
...
<span id="MsgSpan_Display"></span>
	 ...
	 <span id="MsgSpan_Email"></span>		</td>
	  ...
	  <? if(empty($_GET['edit'])){ ?>
        ...
        <td   align="left" ><input name="Password" type="Password" class="inputbox" id="Password" value="<?php echo stripslashes($arryCompany[0]['Password']); ?>"  maxlength="15" />          <span><?=$MSG[150]?></span></td>
      </tr>		 
	  <tr>
