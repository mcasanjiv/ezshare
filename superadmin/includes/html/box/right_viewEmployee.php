...
<input id="ToDate" name="ToDate" readonly="" value="<?=$ToDate?>"  type="text" > 
                    ...
                    <fieldset>
						...
						<select name="sortby" id="sortby">
								...
								<!--option value="e2.UserName" <? if($_GET['sortby']=='e2.UserName') echo 'selected';?>>Supervisor</option-->
                    ...
                    <fieldset>
                     	<input name="cmp" type="hidden" class="button_btn" value="<?php echo $_GET['cmp'];?>"  />
