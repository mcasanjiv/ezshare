...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" align="center">
 <tr>
        <td align="right" height="30"><a href="editAttribute.php?att=<?=$_GET['att']?>" >Add <?=$ModuleName?></a></td>
 </tr>
</table>
...
echo '<a href="editAttribute.php?active_id='.$values["value_id"].'&curP='.$_GET["curP"].'&att='.$_GET["att"].'" class="edit">'.$status.'</a>';
?></td>
      <td  align="center"  ><a href="editAttribute.php?edit=<?php echo $values['value_id'];?>&amp;curP=<?php echo $_GET['curP'];?>&att=<?=$_GET['att']?>" ><?=$edit?></a>
 
<a href="editAttribute.php?del_id=<?php echo $values['value_id'];?>&amp;curP=<?php echo $_GET['curP'];?>&att=<?=$_GET['att']?>" onclick="return confDel('<?=$ModuleName?>')"  ><?=$delete?></a>   </td>
    </tr>
    <?php } // foreach end //?>
