...
//==================== Single query method ======================================
 ...
 $errMsg = "Please log into Facebook. After that you can Post on facebook";
	...
	$errorvalidate['message']='Please Enter Message';	
	 ...
	 if(empty($_POST['name'])){
	$errorvalidate['name']='Please Enter Name';	
	}
	 if(empty($_POST['caption'])){
	$errorvalidate['caption']='Please Enter Caption';	
	}
	 if(empty($_POST['description'])){
	$errorvalidate['description']='Please Enter Description';	
	}
	...
	if(empty($errorvalidate)){
	 if(!empty($_FILES['picture_one']['name'])){
		 ...
		 if(!empty($_POST['picture'])){	 
		   $imageurl=file_get_contents($_POST['picture']);
		 }
		...
		// $_SESSION['mess_social']='<div class="error">'.implode('<br/>',$errorvalidate).'</div>';
