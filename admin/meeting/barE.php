<?php
	...
	$arrySubDepartment = array("");
           $arrySubDepartment[0] ['Department'] = "Task";
           $arrySubDepartment[1] ['Department'] = "Call";
           $arrySubDepartment[2] ['Department'] = "Meeting";
	for($i=0;$i<sizeof($arrySubDepartment);$i++) {
		$arryNumEmployee = $objActivity->GetNumActivityYear($arrySubDepartment[$i]['Department'],'','');
		#$rand = rand(10,80);
		$valuesBar[$arrySubDepartment[$i]['Department']] = $arryNumEmployee[0]['TotalActivity']+$rand;
	}
