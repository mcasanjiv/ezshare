...
$arrySubDepartment = array("");

$arrySubDepartment[0]['attribute_value'] = 'Created';
$arrySubDepartment[1]['attribute_value'] = 'Delivered';
$arrySubDepartment[2]['attribute_value'] = 'Reviewed';
$arrySubDepartment[3]['attribute_value'] = 'Accepted';
$arrySubDepartment[4]['attribute_value'] = 'Rejected';
	...
	for($i=0;$i<sizeof($arrySubDepartment);$i++) {
		$arryNumEmployee = $objQuote->GetNumQuote($arrySubDepartment[$i]['attribute_value']);
		#$rand = rand(10,80);
		$valuesBar[$arrySubDepartment[$i]['attribute_value']] = $arryNumEmployee[0]['TotalQuote']+$rand;
	}
