    ...
    <TABLE WIDTH="100%"   BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0 >
        ...
        <tr>  
            <td  valign="top" align="right">
				<a href="postLinkedin.php" class="fancybox add_quick">Create Post</a>
                            ...
                            foreach ($arrySocial as $key => $values) {
                                ...
                                <tr align="left"  bgcolor="<?= $bgcolor ?>">  
                            	   ...
                            	   foreach ($medias as $medialink){                            	
	                            	   if($i==1)
	                            	   break;
                            	 	  $mediahtml.='<img src="'.$medialink.'" alt="'.stripslashes($values['post']).'"> ';
                            	 	  $i++;
                            	 	  }
                            	 	  if(count($medias)>2)
                            	 	  $mediahtml.='  more ...';
                            	   ...
                            	   (!empty($values['media'])) ? (stripslashes($values['media'])) : (NOT_SPECIFIED) ?></td>
                                    ...
                                    <!-- <td>0</td>-->
									 ...
									 <a href="<?php echo $values['link']; ?>" target="_blank" ><?= $view ?></a>
                                    <a href="viewLinkedinPost.php?del_id=<?php echo $values['id']; ?>&amp;curP=<?php echo $_GET['curP']; ?>" onclick="return confirmDialog(this, '<?= $ModuleName ?>')"  ><?= $delete ?></a>   </td>
