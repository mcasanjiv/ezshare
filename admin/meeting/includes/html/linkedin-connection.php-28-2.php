...
//echo "<pre>";print_r($connections->person);die;			  
		...
		echo '<div class="box-header">';
		 if($connection->{'picture-url'}) {
			echo '<span class="pimg"><img src="'.$connection->{'picture-url'}.'"></span>';
		 }else{
		 echo '<span class="pimg"><img src="'._SiteUrl.'images/nouser.jpg" width="70"></span>';
		 }
		 
	echo '<span class="pbtn"><span class="view-profileln"><a href="'.$connection->{'site-standard-profile-request'}->url.'" target="_blank" title="View Linkedin Profile"></a></span>
