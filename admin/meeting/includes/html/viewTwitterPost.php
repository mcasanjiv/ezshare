...
<? 
                     ...
                     //echo "<pre>";print_r($arrySocial);die;
                            ...
                            foreach ($arrySocial as $key => $values) {
                                ...
                                <tr align="left"  bgcolor="<?= $bgcolor ?>">  
                            	   ...
                            	   (!empty($values['media'])) ? (stripslashes($values['media'])) : (NOT_SPECIFIED) ?></td>
                                    ...
                                    <!-- <td>0</td>-->
							 <td  align="center" class="head1_inner"><a href="<?php echo $values['link']; ?>" target="_blank" ><?= $view ?></a>
                                    

                                    <a href="viewTwitterPost.php?del_id=<?php echo $values['id']; ?>&amp;curP=<?php echo $_GET['curP']; ?>" onclick="return confirmDialog(this, '<?= $ModuleName ?>')"  ><?= $delete ?></a>   </td>
