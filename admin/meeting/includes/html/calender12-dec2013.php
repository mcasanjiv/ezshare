...
<div id="Event" title="Create Event" style="width:500px; display:none">
<? if($ModifyLabel==1){?>
...
ew_CreateEditor(); 
   ...
   <tr>
	...
	<? if($_GET['edit'] >0) $ButtonTitle = 'Update '; else $ButtonTitle =  ' Submit ';?>
      ...
      <a href="javascript:;" onclick="window.location = 'editActivity.php?module=Activity&mode=Event';" class="button"  >Go to Full form</a>
