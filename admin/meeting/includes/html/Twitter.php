...
<tr>
    <td  align="center" valign="top" >
			...
			<div id="Shape3"><img src="<?php echo _SiteUrl;?>/admin/crm/images/Shape3.png" value=""></div>
                        <div id="Typeyoursearchhere"><input type="text" name="q" value="<?php echo !empty($_GET['q'])?$_GET['q']:'Search';?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '<?php echo !empty($_GET['q'])?$_GET['q']:'Search';?>';}" />
...
echo '</ul>';
	...
	foreach($results as $result){	
		...
		echo '</div>';
                echo '<div class="detail-box"><div class="pfname"><a href="https://twitter.com/'.$result->screen_name.'" target="_blank">&nbsp;'.$result->name.'</a></div><div class="pbtn">
