...
<style>
	...
	#calendar {
		...
		.Socialhad{background-color: #007DBA;}
		.profile-box{}
		.profile-box .pdata {
...
.Hwrap { border: 1px solid #999 !important;}
 .pcoln { }
...
<div class="Hwrap" style="min-height:150px;">
<div class="had Socialhad">Social Profile</div>
...
<tr>
<td align="left"><?php echo '<img style="border-radius: 35px !important; margin-left: 25px; margin-top: 10px;" src="'.$data['image'].'" alt="'.$data['first_name'].'" width="70">';?></td>
