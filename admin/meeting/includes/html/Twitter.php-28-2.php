		...
		.fc-event-inner .fc-event-time{ color:#FFFFFF;}
                input[type="text"] {
                                ...
                                .user-list div {
                                 ...
                                 .pbtn{float: right !important; margin-right: 5px; width: 41% !important;}
                                 .user-list img {border-radius: 7px; width: 128%;}
                                 .user-list li {height: 240px !important;;}
...
<tr>
    ...
    <?php if(!empty($settings['oauth_access_token']) AND !empty($settings['oauth_access_token_secret'])){?>
			...
			<div id="Shape3"><img src="<?php echo _SiteUrl;?>/admin/crm/images/Shape3.png" value=""></div>
                        <div id="Typeyoursearchhere"><input type="text" name="q" value="<?php echo !empty($_GET['q'])?$_GET['q']:'';?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'TYPE YOUR SEARCH HERE';}" />
...
echo '</ul>';
	...
	foreach($results as $result){	
		echo '<li>';
		echo '<div class="box-header"><span class="pimg"><img src="'.$result->profile_image_url.'"></span>
                <span class="pbtn"> 
