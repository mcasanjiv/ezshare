		 	...
		 	<tr>
          		...
          		<td  align="left" colspan="3" >          	
           			...
           			$socialdata = unserialize($socialdata);
           				echo '<a href="viewprofile.php?id='.$arryContact[0]['FacebookID'].'&type=facebook" class="facebookview fancybox fancybox.iframe" id="triggerf">View Profile</a>';
           			 }else{echo (NOT_SPECIFIED);}?>
                        <div id="pop-upf" style="width: 400px">
                               <?php echo '<iframe  src="viewprofile.php?id='.$arryContact[0]['FacebookID'].'&type=facebook" style="min-height:150px; width: 400px">
</iframe>';?>
                            </div>
          		...
          		<td  align="left" colspan="3" >
           			...
           			$socialdata = unserialize($socialdata);
           				echo '<a href="viewprofile.php?id='.$arryContact[0]['TwitterID'].'&type=twitter" id="triggert">View Profile</a>';
           			 }else{echo (NOT_SPECIFIED);}?>
                        <div id="pop-upt" style="width: 400px">
                                <?php echo '<iframe  src="viewprofile.php?id='.$arryContact[0]['TwitterID'].'&type=twitter" style="min-height:210px; width: 100%;">
</iframe>';?>
                            </div>
          		...
          		<td  align="left" colspan="3" >
           			...
           			$t='linkedin';
           			 ...
           			 echo '<a href="viewprofile.php?id='.$id.'&type='.$t.'" class="linkedinview fancybox fancybox.iframe" id="triggerL">View Profile</a>';
           			 }else{echo (NOT_SPECIFIED);}?>
                        <div id="pop-upL" style="width: 400px">
