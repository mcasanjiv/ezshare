...
<input name="closingdate" type="text" readonly="" class="disabled" size="13" id="closingdate" value="<?php echo stripslashes($arryCampaign[0]['closingdate']); ?>"  maxlength="50" />             </td>
...
<input name="numsent" type="text" class="inputbox" onkeypress="return isDecimalKey(event);"  id="numsent" value="<?php echo stripslashes($arryCampaign[0]['numsent']); ?>" number  maxlength="50" />            </td>
 ...
 <tr >
    ...
    <input name="expectedrevenue" type="text" onkeypress="return isDecimalKey(event);" class="inputbox" id="expectedrevenue" value="<?php echo stripslashes($arryCampaign[0]['expectedrevenue']); ?>"   maxlength="50" />   
	   ...
	   <tr>
        ...
        <td   align="left" >
<input name="expectedsalescount " type="text" onkeypress="return isNumberKey(event);" class="inputbox" id="expectedsalescount" value="<?php echo stripslashes($arryCampaign[0]['expectedsalescount']); ?>" maxlength="15" />            </td>
     
        <td  align="right"   class="blackbold">Actual Sales Count   : </td>
        <td   align="left" >
<input name="actualsalescount " type="text" onkeypress="return isNumberKey(event);" class="inputbox" size="15" id="actualsalescount" value="<?php echo stripslashes($arryCampaign[0]['actualsalescount']); ?>"  maxlength="50" />            </td>
      </tr>

	
	  <tr>
        <td  align="right"   class="blackbold">Expected Response Count  : <span class="red">*</span></td>
        <td   align="left" >
<input name="expectedresponsecount " type="text" onkeypress="return isNumberKey(event);" class="inputbox" size="15" id="expectedresponsecount" value="<?php echo stripslashes($arryCampaign[0]['expectedresponsecount']); ?>"  maxlength="50" />            </td>
     
        <td  align="right"   class="blackbold">Actual Response Count : <span class="red">*</span></td>
        <td   align="left" >
<input name="actualresponsecount" type="text" onkeypress="return isNumberKey(event);" class="inputbox" size="15" id="actualresponsecount" value="<?php echo stripslashes($arryCampaign[0]['actualresponsecount']); ?>"  maxlength="50" />            </td>
      </tr>
	<tr>
        <td  align="right"   class="blackbold"> Expected ROI: (<?=$Config['Currency']?>)  :<span class="red">*</span> </td>
        <td   align="left" >
		
    <input name="expectedroi" type="text" class="inputbox" onkeypress="return isDecimalKey(event);" id="expectedroi" value="<?php echo stripslashes($arryCampaign[0]['expectedroi']); ?>" number  maxlength="50" />   
    ...
    <input name="actualroi" type="text" class="inputbox" onkeypress="return isDecimalKey(event);" id="actualroi" value="<?php echo stripslashes($arryCampaign[0]['actualroi']); ?>" number  maxlength="50" />   
