          ...
          <td  align="left" colspan="3" >
            ...
            <tr>
		 	...
		 	<tr>
          		...
          		<td  align="left" colspan="3" >
           			 <?php if(!empty($arryContact[0]['facebook'])){$socialdata=stripslashes(nl2br($arryContact[0]['facebook']));
           			$socialdata = unserialize($socialdata);
           				echo '<a href="'.$socialdata['url'].'" target="_blank">'.$socialdata['uname'].'</a>';
           			 }else{echo (NOT_SPECIFIED);}?></td>
           		</tr>
           		<tr>
           		<td align="right"   class="blackbold" valign="top">Twitter :</td>
          		<td  align="left" colspan="3" >
           			  <?php if(!empty($arryContact[0]['twitter'])){$socialdata=stripslashes(nl2br($arryContact[0]['twitter']));
           			$socialdata = unserialize($socialdata);
           				echo '<a href="'.$socialdata['url'].'" target="_blank">'.$socialdata['uname'].'</a>';
           			 }else{echo (NOT_SPECIFIED);}?></td>
           		</tr>
          		...
          		<td  align="left" colspan="3" >
           			  <?php if(!empty($arryContact[0]['linkedin'])){$socialdata=stripslashes(nl2br($arryContact[0]['linkedin']));
           			$socialdata = unserialize($socialdata);
           				echo '<a href="'.$socialdata['url'].'" target="_blank">'.$socialdata['uname'].'</a>';
           			 }else{echo (NOT_SPECIFIED);}?></td>
				</tr>
