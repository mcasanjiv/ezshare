...
<style>
.user-list li {height: 200px!important;}
	.ui-widget-overlay{
                                ...
                                .user-list div {
                                 ...
                                 .user-list img {
                                              ...
                                              #Forma3copy > img {
                                               ...
                                               #sexy-search {   margin-left: 172px;
                                                                margin-top: -55px;
                                                                position: absolute;}
                                              #socialfrom {margin-top: 70px;}
                                              #Forma3copia > img {
                                                                        height: 16px;
                                                                    }
...
<tr>
    ...
    <td  align="center" valign="top" style="display:none;" id="searchfbbox">
			...
			<div id="Shape3"><img src="<?php echo _SiteUrl;?>/admin/crm/images/Shape3.png" value=""></div>
                        <div id="Typeyoursearchhere"><input name="q" type="text" value="<?php echo !empty($_GET['q'])?$_GET['q']:'';?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'TYPE YOUR SEARCH HERE';}" />
...
<? } ?>
		...
		$i=0;
			foreach($search_user['userdata'] as $result){
				if($result['id']){
					echo '<li>';
					echo '<div><span class="pimg"><img src="https://graph.facebook.com/'.$result['id'].'/picture"></span>
<span class="pbtn">                                            
<span class="view-profile"><a href="'.$result['link'].'" target="_blank" rel="Profile" name="Profile" title="View Facebook Profile"></a></span>
			...
			<!--<a href="javascript:void(0);" onclick="jQuery(this).parents(\'li\').find(\'.add-dashboard\').toggleClass(\'active\')">Add To CRM</a> -->
			       ...
			       <span class="exiting-profile"><a name="Add Existing" title="Add Existing" href="javascript:void(0);" onclick="addtoexistingcrm(\''.$i.'\')"></a></span>';
