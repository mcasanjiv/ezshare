...
<? } ?>
		...
		<tr>
			...
			<td   align="left" >
			<Textarea name="message" class="inputbox" style="height: 65px;"></Textarea>       </td>
			</tr>
			
			<tr>
			<td  align="right" width="40%"   class="blackbold"> Link  :<span class="red">*</span> </td>
			<td   align="left" >
			<input name="link" type="text" class="inputbox" id="title" value=""  maxlength="50" /></td>
			</tr>
			
			<tr>
			<td  align="right" width="40%"   class="blackbold"> Picture  :<span class="red">*</span> </td>
			<td   align="left" >
			<input name="picture" type="text" class="inputbox" id="title" value=""  maxlength="50" /></td>
			</tr>
			
			<tr>
			<td  align="right" width="40%"   class="blackbold">Name  :<span class="red">*</span> </td>
			<td   align="left" >
			<input name="name" type="text" class="inputbox" id="title" value=""  maxlength="50" /></td>
			</tr>
			
			<tr>
			<td  align="right" width="40%"   class="blackbold">Caption  :<span class="red">*</span> </td>
			<td   align="left" >
			<input name="caption" type="text" class="inputbox" id="title" value=""  maxlength="50" /></td>
			</tr>
			
			<tr>
			<td  align="right" width="40%"   class="blackbold">Description  :<span class="red">*</span> </td>
			<td   align="left" >
		    <Textarea name="description" id="description" class="inputbox" style="height: 65px;"></Textarea>
            </td>
			</tr>
			</table>	
			</td>
