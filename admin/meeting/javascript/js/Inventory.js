...
var rowCnt=rowCnt+1;
	...
	temp='<input id="qty'+count+'" name="qty'+count+'" type="text" onkeyup="numValue(this);"  class="small " style="width:50px" onfocus="this.className=\'detailedViewTextBoxOn\'" onBlur="settotalnoofrows(); calcTotal(); loadTaxes_Ajax('+count+');';
	if(module == "Invoice")
        {
