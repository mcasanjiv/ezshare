...
$(document).ready(function(){	
	...
	function myDayClickHandler(eventObj){
		...
		//alert(date);
	window.location.href = "editEvent.php?module=Event&date="+ clickDate +"&month="+ (date.getMonth()+1) +"&date="+ date.getDate();
	...
	function myAgendaClickHandler(eventObj){
		...
		window.location.href = "vEvent.php?view="+agendaId+"module=Event&date="+ clickDate +"&month="+ (date.getMonth()+1) +"&date="+ date.getDate();
	...
	function myAgendaDropHandler(eventObj){
		...
		// Pull agenda item from calendar
		var agendaItem = jfcalplugin.getAgendaItemById("#mycal",agendaId);		
		alert("You dropped Activity " + agendaItem.title + 
