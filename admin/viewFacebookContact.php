<script language="JavaScript1.2" type="text/javascript">
    ...
    {
        location.href = "viewTwitterContact.php?customview=" + id + "&module=Socialcrm&search=Search";
        LoaderSearch();
    }
</script>
                                        ...
                                        <td><?= (!empty($values['location'])) ? (stripslashes($values['location'])) : (NOT_SPECIFIED) ?></td>
										 <td align="center">
                                            <?= (!empty($values['date'])) ? (date('m-d-Y h:i:s',strtotime(stripslashes($values['date'])))) : (NOT_SPECIFIED) ?>		
                                    				 ...
                                    				 <td  align="center" class="head1_inner"><a href="https://www.facebook.com/profile.php?id=<?php echo $values['social_id']; ?>" target="_blank" ><?= $view ?></a>
                                    

                                    <a href="viewFacebookContact.php?del_id=<?php echo $values['id']; ?>&amp;curP=<?php echo $_GET['curP']; ?>" onclick="return confirmDialog(this, '<?= $ModuleName ?>')"  ><?= $delete ?></a>   </td>
