...
if ($_GET['type'] == 'Journal') {
    ...
    $column = array
        (
        array("colum_name" => "Deposit To", "table_name" => "p_order", "colum_value" => "AccountName"),     
    ...
    $column = array
        ...
        array("colum_name" => "Customer", "table_name" => "f_payment", "colum_value" => "CustomerName"),
    ...
    $column = array
        ...
        array("colum_name" => "Vendor", "table_name" => "f_payment", "colum_value" => "SuppCompany"),
        array("colum_name" => "Entry Type", "table_name" => "f_payment", "colum_value" => "EntryType"),
        //array("colum_name" => "Amount", "table_name" => "f_payment", "colum_value" => "CreditAmnt"),
        array("colum_name" => "Currency", "table_name" => "f_payment", "colum_value" => "Currency"),
        array("colum_name" => "Payment Status", "table_name" => "f_payment", "colum_value" => "InvoicePaid"),
    );
    ...
    $column = array
        (
        array("colum_name" => "Credit Note ID", "table_name" => "p_order", "colum_value" => "CreditID"),
        array("colum_name" => " Posted Date", "table_name" => "p_order", "colum_value" => "PostedDate"),
        array("colum_name" => "Expiry Date", "table_name" => "p_order", "colum_value" => "ClosedDate"),
        ...
        array("colum_name" => "Status", "table_name" => "p_order", "colum_value" => "Status")
    );
...
}else if ($_GET['type'] == 'PoInvoice') {
    $ThisPageName = 'viewPoInvoice.php';
    $column = array
        (
        array("colum_name" => "Entry Type", "table_name" => "s_order", "colum_value" => "EntryType"),
        array("colum_name" => "Invoice Number", "table_name" => "s_order", "colum_value" => "InvoiceID"),
        array("colum_name" => "PO/Reference Number", "table_name" => "s_order", "colum_value" => "PurchaseID"),
        array("colum_name" => "Vendor", "table_name" => "s_order", "colum_value" => "SuppCompany"), 
        array("colum_name" => "Invoice Paid", "table_name" => "s_order", "colum_value" => "InvoicePaid"),
        array("colum_name" => "Amount", "table_name" => "s_order", "colum_value" => "TotalAmount"),
       array("colum_name" => "Currency", "table_name" => "p_order", "colum_value" => "SuppCurrency"),
        array("colum_name" => "Invoice Date", "table_name" => "s_order", "colum_value" => "PostedDate"),
    ...
    $column2 = array
        ...
        array("colum_name" => "Invoice Paid", "table_name" => "s_order", "colum_value" => "InvoicePaid"),
        array("colum_name" => "Amount", "table_name" => "s_order", "colum_value" => "TotalAmount"),
        array("colum_name" => "Currency", "table_name" => "s_order", "colum_value" => "SuppCurrency"),
        //array("colum_name" => "Invoice Date", "table_name" => "s_order", "colum_value" => "InvoiceDate"),
        array("colum_name" => "Shipping Method", "table_name" => "s_order", "colum_value" => "ShippingMethod"),
        array("colum_name" => "Comments", "table_name" => "s_order", "colum_value" => "Comment")
...
}else if ($_GET['type'] == 'Vendor') {
    $ThisPageName = 'viewSupplier.php';
    $column = array
        (
        array("colum_name" => "Vendor Code", "table_name" => "s_order", "colum_value" => "SuppCode"),
        array("colum_name" => "Company Name", "table_name" => "s_order", "colum_value" => "CompanyName"),
        array("colum_name" => "Currency", "table_name" => "s_order", "colum_value" => "Currency"),
        array("colum_name" => "Vendor Since", "table_name" => "s_order", "colum_value" => "SupplierSince"), 
        ...
        array("colum_name" => "Shipping Method", "table_name" => "p_order", "colum_value" => "ShippingMethod"),
        array("colum_name" => "Status", "table_name" => "s_order", "colum_value" => "Status"),
        array("colum_name" => "First Name", "table_name" => "s_order", "colum_value" => "FirstName"),
        array("colum_name" => "Last Name", "table_name" => "s_order", "colum_value" => "LastName"), 
        array("colum_name" => "Email", "table_name" => "p_order", "colum_value" => "Email"),
        array("colum_name" => "Address", "table_name" => "s_order", "colum_value" => "Address"),
        array("colum_name" => "Zip Code", "table_name" => "s_order", "colum_value" => "ZipCode"),
        array("colum_name" => "Mobile", "table_name" => "s_order", "colum_value" => "Mobile")
    );
