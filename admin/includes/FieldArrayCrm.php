...
if ($_GET['type'] == 'Ticket') {
    ...
    $column2 = array
        ...
        array("colum_name" => "Subject", "table_name" => "c_document", "colum_value" => "subject"),
        array("colum_name" => "Assigned To", "table_name" => "c_campaign", "colum_value" => "assignedTo"),
 	array("colum_name" => "Created By", "table_name" => "c_campaign", "colum_value" => "created_id"),
        //array("colum_name"=>"Start Date & Time","table_name"=>"c_document","colum_value"=>"startDate"),
        //array("colum_name"=>"End Date & Time","table_name"=>"c_document","colum_value"=>"closeDate"),
        array("colum_name" => "Status", "table_name" => "c_document", "colum_value" => "status"),
        array("colum_name" => "Activity Type", "table_name" => "c_document", "colum_value" => "activityType"),
    ...
    $ThisPageName = 'viewContact.php?module=contact';
    $column = array
        (
        array("colum_name" => "Contact Name", "table_name" => "p_order", "colum_value" => "FullName"),
        array("colum_name" => "Email", "table_name" => "p_order", "colum_value" => "Email"),
        array("colum_name" => "Personal Email ", "table_name" => "p_order", "colum_value" => "PersonalEmail"),
        array("colum_name" => "Title", "table_name" => "p_order", "colum_value" => "Title"),
        array("colum_name" => "Department", "table_name" => "p_order", "colum_value" => "Department"),
        array("colum_name" => "Lead Source", "table_name" => "p_order", "colum_value" => "LeadSource"),
        array("colum_name" => "Assigned To ", "table_name" => "p_order", "colum_value" => "AssignTo"),
        array("colum_name" => "Reference", "table_name" => "p_order", "colum_value" => "Reference"),
        array("colum_name" => "Do Not Call ", "table_name" => "p_order", "colum_value" => "DoNotCall"),
        //array("colum_name" => "Notify Owner ", "table_name" => "p_order", "colum_value" => "notify_owner"),
         array("colum_name" => "Customer ", "table_name" => "p_order", "colum_value" => "CustID"),
        array("colum_name" => "Email Opt Out", "table_name" => "p_order", "colum_value" => "EmailOptOut"),
        array("colum_name" => "Status", "table_name" => "p_order", "colum_value" => "Status"),       
        array("colum_name" => "Address ", "table_name" => "p_order", "colum_value" => "Address"),
        array("colum_name" => "Country ", "table_name" => "p_order", "colum_value" => "CountryName"),
        array("colum_name" => "State", "table_name" => "p_order", "colum_value" => "StateName"),
        array("colum_name" => "City ", "table_name" => "p_order", "colum_value" => "CityName"),  
        array("colum_name" => "Zip Code ", "table_name" => "p_order", "colum_value" => "ZipCode"),
        array("colum_name" => "Mobile", "table_name" => "p_order", "colum_value" => "Mobile"),
        array("colum_name" => "Description", "table_name" => "p_order", "colum_value" => "Description")
    );
