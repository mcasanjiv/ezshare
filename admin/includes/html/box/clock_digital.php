...
if($SelfPage=='home.php' || $WithingDeptClock==1)$SupPrefx='../';
?>
<link rel="stylesheet" type="text/css" href="<?=$SupPrefx?>clock/css/digital.css"> 
...
var jq = $.noConflict();
 jq(document).ready(function() {
   jq('#digital-clock').clock({offset: '<?=$FinalOffset?>', type: 'digital'});
 });
</script>


<ul id="digital-clock" class="digital" <?=$digitalStyle?> <?=$digitalAttrib?>>	
	<li class="hour"></li>
	<li class="min"></li>
	<li class="sec"></li>
