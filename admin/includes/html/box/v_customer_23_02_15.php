		 	...
		 	<tr>
          		...
          		<td  align="left" colspan="3" >          	
           			...
           			$socialdata = unserialize($socialdata);
           				echo '<a href="viewprofile.php?id='.$arryCustomer[0]['FacebookID'].'&type=facebook" class="fancybox fancybox.iframe">View Profile</a>';
          		...
          		<td  align="left" colspan="3" >
           			...
           			$socialdata = unserialize($socialdata);
           				echo '<a href="viewprofile.php?id='.$arryCustomer[0]['TwitterID'].'&type=twitter" class="fancybox fancybox.iframe">View Profile</a>';
           			 }else{echo (NOT_SPECIFIED);}?></td>
           		</tr>
           		<tr>
          		...
          		<td  align="left" colspan="3" >
           			...
           			$id=$arryCustomer[0]['FacebookID'];
           			$t='facebook';
           			}elseif(!empty($arryCustomer[0]['TwitterID'])){
           			$id=$arryCustomer[0]['TwitterID'];
           			$t='twitter';
