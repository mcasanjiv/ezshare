 <tr>
		...
		<td   align="left">
                ...
                <?php if($arryRecurr[0]['EntryType'] == "recurring" && $arryRecurr[0]['EntryInterval'] != 'weekly' && $arryRecurr[0]['EntryInterval'] != 'biweekly' && $arryRecurr[0]['EntryInterval'] != 'daily' && $arryRecurr[0]['EntryInterval'] != 'semi_monthly'){?>  
 ...
 if($arryRecurr[0]['EntryType'] == "recurring"){?>	
		...
		<td  align="left" class="blacknormal">
                    ...
                    ?>
                     ...
                     <?php if($EntryInterval == "semi_monthly"){ $EntryInterval = "Semi Monthly";  }?>
		...
		<td  align="left" class="blacknormal">
                ...
                <?php } else if($arryRecurr[0]['EntryInterval'] == "weekly" || $arryRecurr[0]['EntryInterval'] == "biweekly"){ ?>
                 <td  align="right" class="blackbold">Every :</td>
		<td  align="left" class="blacknormal">            
                        <?=$arryRecurr[0]['EntryWeekly'];?>
