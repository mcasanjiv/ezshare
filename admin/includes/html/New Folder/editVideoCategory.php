<div class="had">
<? 
$MemberTitle = (!empty($_GET['edit']))?("&nbsp; Edit Video ") :("&nbsp; Add Video ");
...
<TABLE WIDTH=500   BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0 >
	  ...
	  <TD align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  <div  align="right"><a href="<?=$ListUrl?>" class="Blue">List Video Categories</a>&nbsp;</div><br>
...
function ValidateForm(frm)
{
	...
	if(  ValidateForBlank(frm.Name, module_title) 
		...
		var Url = "isRecordExists.php?VideoCategoryName="+escape(document.getElementById("Name").value)+"&editID="+document.getElementById("catID").value;
