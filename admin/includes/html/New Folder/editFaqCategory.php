...
function ValidateForm(frm)
{
	...
	if(  ValidateForBlank(frm.Name, module_title) 
		...
		/*
		var Url = "isRecordExists.php?FaqCategoryName="+escape(document.getElementById("Name").value)+"&editID="+document.getElementById("catID").value;
...
<div class="had">
<? 
$MemberTitle = (!empty($_GET['edit']))?("&nbsp; Edit Faq ") :("&nbsp; Add Faq ");
...
<TABLE WIDTH=500   BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0 >
	  ...
	  <TD align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
		  ...
		  <div  align="right"><a href="<?=$ListUrl?>" class="Blue">List Faq Categories</a>&nbsp;</div><br>
                ...
                <tr>
                  <td align="center" valign="top" ><table width="100%" border="0" cellpadding="5" cellspacing="1" >
                    <tr>
                      ...
                      <td width="56%"  align="left" valign="top"><input  name="Name" id="Name" value="<?=stripslashes($arryCategory[0]['Name'])?>" type="text" class="inputbox"  size="30" maxlength="255" />					  </td>
                    </tr>
                    <tr >
