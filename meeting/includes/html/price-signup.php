...
<div class="section">
<h1 class="title" id="page-title">EZnet CRM Pricing &amp; Signup</h1>
<div class="tabs">&nbsp;</div>
<div id="banner">
...
<div class="more"><a
	href="<?php echo $_SERVER['PHP_SELF']; ?>?slug=crm-comparison">Plan
Details</a>
</div>
...
<div class="tryNow"><?php if(!empty($_SESSION['CrmDisplayName'])){?> <a
	href="index.php?slug=upgrade&pack_id=<?php echo $pricePackg['id'];?>">TRY
NOW</a> <?php } else{ ?> <a href="index.php?slug=user">TRY NOW</a> <?php } ?>
</div>
