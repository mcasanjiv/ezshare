		...
		<div id="mainContainer">
			...
			<header id="headerArea">
				...
				<div class="wrap clearfix">
					...
					<li class="login">Welcome : <i><?php echo $_SESSION['DisplayName']; ?></li>
					<li class="login"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?slug=user">Log Out</a></li>
					
					<?php }else{?>
										
						<li class="login"><a href="http://66.55.11.23/erp/crm/"
							target="_blank">Application Login</a></li>
						
					<?php }?>
				

							
						<li class="login"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?slug=user">Manage
								Account</a></li>
					</ul>
					<nav class="menuArea">
						...
						<article id="leftPart">
							...
							<div class="detailedContent">
								<div class="column" id="content">
									...
									<span>Please <a href="index.php?slug=user"> click here </a> to login</span>
	                               <?php }else {?>
