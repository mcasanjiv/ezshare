...
/**************************************************************/
$ThisPageName = 'getJoinMeetingUrlAttendee_popup.php'; $EditPage = 1;
/**************************************************************/
...
<div style=''>
			<div id='joinMeeting'  aria-hidden="false" aria-labelledby="myModalLabel1" role="dialog" tabindex="-1">
                                          ...
                                          <div class="control-group">
                                            ...
                                            MeetingId 
                                             ...
                                             <div class="controls controls-row">
                                                <input class="span4" type="text" name="meetingId" value="<?php echo stripslashes($arryMeeting[0]['meetingId']); ?>">
                                             </div>
										   ...
										   <div class="control-group">
                                            ...
                                            Attendee Name
                                             ...
                                             <div class="controls controls-row">
                                                <input class="span4" type="text" name="meetingName" id="meetingName" value="" required>
                                             </div>
                                          </div>
										   <div class="control-group">
                                             <label class="control-label">
                                           Password
                                             ...
                                             <div class="controls controls-row">
         <input class="span4" type="text" name="password" id="password" value="<?php echo stripslashes($arryMeeting[0]['attendeePw']); ?>">
     ...
     <? if ($_GET['join'] > 0) $ButtonTitle = 'Joinmeeting ';     
                                ...
                                <button type="submit" class="btn btn-success remove-margin" value="<?= $ButtonTitle ?>" name="Joinmeeting"> Join</button>
