...
/**************************************************************/
$ThisPageName = 'getJoinMeetingUrlModerator_popup.php'; $EditPage = 1;
/**************************************************************/
                                          ...
                                          <div class="control-group">
                                            ...
                                            MeetingId 
                                             ...
                                             <div class="controls controls-row">
                                                <input class="span4" type="text" name="meetingId" value="<?php echo stripslashes($arryMeetingDetail[0]['meetingId']); ?>" readonly>
                                             </div>
										   ...
										   <div class="control-group">
                                            ...
                                            MeetingName
                                             ...
                                             <div class="controls controls-row">
                                                <input class="span4" type="text" name="meetingName" id="meetingName" value="<?php echo stripslashes($arryMeetingDetail[0]['meetingName']); ?>">
                                             </div>
                                          </div>
										   <div class="control-group">
                                             <label class="control-label">
                                           Password
                                             ...
                                             <div class="controls controls-row">
         <input class="span4" type="text" name="password" id="password" value="<?php echo stripslashes($arryMeetingDetail[0]['moderatorPw']); ?>">
