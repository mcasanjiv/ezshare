...
class orders extends dbClass {
    ...
    function saveOrderStatus($arryDetails)
    {
        ...
        if(!empty($OrderStatus))
        {
            $strSQLQuery = "UPDATE e_orders SET OrderComplatedDate = '".$Config['TodayDate']."', OrderStatus = '".$OrderStatus."' WHERE OrderID = '".$oid."'";
            $this->query($strSQLQuery, 0);   
        ...
        if(!empty($PaymentStatus))
        {
            $strSQLQuery = "UPDATE e_orders SET PaymentStatus = '".$PaymentStatus."' WHERE OrderID = '".$oid."'";
            $this->query($strSQLQuery, 0);   
        }
    }
