...
class pager{
	...
	function setPager(){				
				...
				if ($this->intCurrentPage > 1) {
					...
					$this->strShowPaging.="<a href=\"".basename($_SERVER['PHP_SELF'])."?curP=".$intPreviousPage."&".$this->strURL."\" class=\"pagenumber prev\">&#8249 Previous</a>";			
				}				
			...
			if ($this->intCurrentPage < $this->intLoopEndPoint) {
				...
				$this->strShowPaging.="<a href=\"".basename($_SERVER['PHP_SELF'])."?curP=".$intNextPage."&".$this->strURL."\" class=\"pagenumber next\">Next &#8250; </a> ";
			}
