...
class company extends dbClass
{
		...
		function  GetCompanyBrief($CmpID)
		{
			...
			$strSQLQuery = "select c.CmpID, c.CompanyName, c.DisplayName, c.Email, c.Image, c.Timezone, c.DateFormat, c.TimeFormat, c.SessionTimeout, c.Department, c.currency_id, c.MaxUser,c.RecordsPerPage, c.StorageLimit , c.StorageLimitUnit,c.Storage,c.TrackInventory,c.ExpiryDate,c.AdditionalCurrency from company c where c.Status=1 ".$strAddQuery." order by c.CmpID asc";
			return $this->query($strSQLQuery, 1);
		}
