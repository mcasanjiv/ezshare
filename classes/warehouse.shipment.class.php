...
function  ListShipment($arryDetails)
		{
			...
			$strSQLQuery = "select o.ShippedDate,s.ShipmentDate, o.ShippedID as ShippingID,o.OrderDate, o.InvoiceDate, o.OrderID, o.SaleID,o.InvoiceID, o.CustCode, o.CustomerName, o.TotalAmount, o.CustomerCurrency,o.SalesPersonID,o.SalesPerson,s.RefID, s.OrderID as InvID, s.ShipComment,ShipmentStatus,s.ShippedID   from s_order o left  join w_shipment  s  on o.OrderID=s.ShippedID  ".$strAddQuery;
		//echo $strSQLQuery;
