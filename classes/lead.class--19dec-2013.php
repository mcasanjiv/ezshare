...
function addDocAssign($arryDetails)
		...
		$sql = "select a.*,e.UserName,e.EmpID,e.Department,e.JobTitle,e.Image,d.Department as emp_dep,d.depID from c_doc_assign a left outer join  h_employee e on e.EmpID=a.EmpID left outer join  department d on e.Department=d.depID ".$sql." order by a.EmpID Asc" ; 
